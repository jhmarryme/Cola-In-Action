...
public class BrowserSecurityController {
     ...
     * @return com.jhmarryme.cola.dto.Response
     */
    ...
    public Response requireAuthentication(HttpServletRequest request, HttpServletResponse response) {
        ...
        return Response.buildFailure(BrowserErrorEnum.NEED_AUTHENTICATION.getErrorCode(),
                BrowserErrorEnum.NEED_AUTHENTICATION.getErrorMsg());
    }
