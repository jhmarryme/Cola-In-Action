...
public abstract class Assert {
     ...
     * @param params 当提供错误码时, 才有额外参数
     * @throws BizException if expression is {@code false}
     */
    public static void isTrue(boolean expression, String errorCode, String errMessage, String... params) {
        if (!expression) {
            throw new BizException(errorCode, errMessage, params);
        }
    }
     ...
     */
    public static void isFalse(boolean expression, String errorCode, String errMessage, String... params) {
        if (expression) {
            throw new BizException(errorCode, errMessage, params);
        }
    }
    ...
    public static void notNull(Object object, String errorCode, String errMessage, String... params) {
        if (object == null) {
            throw new BizException(errorCode, errMessage, params);
        }
    }
    ...
    public static void notEmpty(Collection<?> collection, String errorCode, String errMessage, String... params) {
    ...
    public static void notEmpty(Map<?, ?> map, String errorCode, String errMessage, String... params) {
